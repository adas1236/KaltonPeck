...
\uses{def:weak-form}
\lean{KaltonPeck.StrongSymplecticForm}\leanok
\end{definition}
...
\lean{KaltonPeck.transpose,KaltonPeck.StrongSymplecticForm.adjoint}\leanok
\end{definition}
...
\]
\lean{KaltonPeck.IsFredholm,KaltonPeck.HasFiniteRank,KaltonPeck.operatorRank,KaltonPeck.nullity}\leanok
\end{definition}
...
$\dim(X/H)=1$.
\lean{KaltonPeck.IsComplexStructure,KaltonPeck.IsHyperplane}\leanok
\end{definition}

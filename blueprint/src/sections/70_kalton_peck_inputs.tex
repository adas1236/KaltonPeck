...
\[
  ...
  \qquad(z\in Z).
\]
\lean{KaltonPeck.IsSquareSummable,KaltonPeck.l2Norm,KaltonPeck.centralizer,KaltonPeck.IsAdmissiblePair,KaltonPeck.kaltonPeckQuasiNorm,KaltonPeck.RealKaltonPeckPresentation}\leanok
\end{definition}
